...
**important note**
If you'll be following on with my learning of Python, you may want to try out some of the examples I provide or follow along with the coding. I'd strongly recommend you check the version you are using of Python as it does make a difference in coding style sometimes.
